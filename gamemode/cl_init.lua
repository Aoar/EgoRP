GM.Version = "2.4.3"
GM.Name = "EgoRP"
GM.Author = "By Rickster, Updated: Pcwizdan, Sibre, philxyz, [GNC] Matt, Chrome Bolt, FPtje Falco, Eusion, Drakehawke, Updated EgoRP: Aoar, Zero"
DarkRP
...
EgoRP:
Aoar (STEAM_0:0:24796812)
Zero (STEAM_0:1:17161067)]]

local function credits(um)
	chat.AddText(Color(255,0,0,255), "CREDITS FOR EgoRP", Color(0,0,255,255), creds)
end
