...
function PANEL:Init()
	...
	self.imgAvatar = vgui.Create( "SpawnIcon", self )
...
function PANEL:Paint()
	...
	if( ValidEntity( ply ) && RP.Teams[ply.Class] && RP.Teams[ply.Class].color ) then
		local ct = RP.Teams[ply.Class].color
		color = Color( ct.r, ct.g, ct.b, 255 )
	else
		color = Color( 100, 200, 200, 255 )
	end
...
function PANEL:SetPlayer( ply )
	...
	self.imgAvatar:SetModel( ply:GetModel() )
	self.imgAvatar:SetIconSize(32)
...
function PANEL:UpdatePlayerData()
	...
	self.imgAvatar:SetModel( self.Player:GetModel() )
